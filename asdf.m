...
for episodesCt = 1:numEpisodes
    ...
    Episodes = struct;
    for k = stationManagement.activeIDs(stationManagement.maxCAM+1):stationManagement.activeIDs(end)
    ...
    for i = stationManagement.activeIDs(stationManagement.maxCAM+1):stationManagement.activeIDs(end)
    ...
    cumulative_reward = cumulative_reward/length(stationManagement.activeIDs(stationManagement.maxCAM+1:end));
