function [updateTimeMatrix,updateDelayCounter] = countUpdateDelay(stationManagement,iPhyRaw,IDvehicleTX,indexVehicleTX,awarenessID,correctRxList,correctRxList_DENM,correctRxList_CAM,elapsedTime,updateTimeMatrix,updateDelayCounter,delayResolution,simValues)
