function [phyParams,simValues,outputValues,sinrManagement,stationManagement,timeManagement,expManagement,Agents,Episodes,Critics,TargetCritics,Buffer] = ...
...
if simParams.BRAlgorithm == constants.REASSIGN_BR_STD_MODE_4
    ...
    [timeManagement,stationManagement,sinrManagement,Nreassign,simValues,expManagement,Agents,Episodes,Critics,TargetCritics,Buffer] = ...
        BRreassignment3GPPautonomous(timeManagement,stationManagement,positionManagement,sinrManagement,simParams,phyParams,appParams,outParams,simValues,expManagement,Agents,Episodes,EpisodesVector,Critics,TargetCritics,Buffer,Epsilons,obsInfo,actInfo,trainingMode,sharingReplay,criticOpts,outputValues);
