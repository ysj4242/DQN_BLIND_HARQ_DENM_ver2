...
switch simParams.BRAlgorithm
    ...
    %     end
        ...
        [simParams,varargin]= addNewParam(simParams,'T2autonomousMode_min',5,'Minimum time for the next allocation in autonomous mode','integer',fileCfg,varargin{1});
            if simParams.T2autonomousMode<20 || simParams.T2autonomousMode>100
                error('Error: "simParams.T2autonomousMode" must be between 20 and 100 ms in LTE and 5G');
            end

        % [T2autonomousMode_DENM]
        % Maximum time for the next allocation in ms
        [simParams,varargin]= addNewParam(simParams,'T2autonomousMode_DENM',33,'Maximum time for the next allocation in autonomous mode','integer',fileCfg,varargin{1});
            if simParams.T2autonomousMode<20 || simParams.T2autonomousMode>100
                error('Error: "simParams.T2autonomousMode" must be between 20 and 100 ms in LTE and 5G');
            end
        ...
        simParams.T2autonomousModeTTIs_min = simParams.T2autonomousMode_min*(2^phyParams.muNumerology);    % T2 in terms of TTIs
        simParams.T2autonomousModeTTIs_DENM = simParams.T2autonomousMode_DENM*(2^phyParams.muNumerology);    % T2 in terms of TTIs
